...
<body id="page-top">
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item"><a class="login-btn" href="#" data-toggle="modal"
                data-target="#loginPopUp"
            >用户登陆</a></li>
            <li class="sidebar-nav-item"><a class="register" href="#" data-toggle="modal"
                data-target="#registerPopUp"
            >用户注册</a></li>
            <li class="sidebar-nav-item"><a class="js-scroll-trigger" href="#about">随便看看</a></li>
            <!-- <li class="sidebar-nav-item">
                <a class="js-scroll-trigger" href="#footerInfo">关于我们</a>
            </li> -->
            <li class="sidebar-nav-item"><a class="js-scroll-trigger" href="#footerInfo">版权所有</a></li>
        </ul>
    </nav>
    <header class="masthead d-flex">
        <div class="container text-center my-auto">
            <h1 class="mb-1">Unicom Blog System</h1>
            <h3 class="mb-5">书写你的简单生活</h3>
                ...
                <div class="modal-body">
                    ...
                    <form action="<%=basePath%>/LoginServlet" method="get">
                        <div class="form-group">
                            <label for="userId" class="font-weight-bold">用户名</label> <input type="text"
                                class="form-control" name="username" placeholder="请输入用户名" pattern="[a-zA-z]{6-12}"
                                required
                            >
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">密码</label> <input type="password" class="form-control"
                                name="password" placeholder="请输入密码" pattern="[0-9]{6,}" required
                            >
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<%=basePath%>/RegistServlet" method="get">
                        <div class="form-group">
                            <label for="userId" class="font-weight-bold">用户名</label> <input type="text"
                                class="form-control" id="userId" name="username" placeholder="请输入用户名"
                            >
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">密码</label> <input type="password" class="form-control"
                                id="pwd" name="password" placeholder="请输入密码"
                            >
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">确认密码</label> <input type="password" class="form-control"
                                id="pwd1" placeholder="请确认密码" onkeypress="pwdRecover()"
                            >
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">昵称</label> <input type="text" class="form-control" id="text"
    ...
    <div class="container" id="about">
        ...
        <div class="jumbotron p-4 p-md-5 text-white rounded">
            <div class="col-md-6 px-0">
                ...
                <p class="lead mb-0">
                    <a href="https://getbootstrap.com/docs/4.3/examples/blog/#" class="text-white font-weight-bold">Continue
                        reading...</a>
                </p>
            </div>
        </div>
