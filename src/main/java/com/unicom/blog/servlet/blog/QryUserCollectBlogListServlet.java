 ...
 *
 */
@WebServlet("/qryUserCollectBlogList")
public class QryUserCollectBlogListServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp){
		...
		try{
	        ...
	        resp.getWriter().print(JSON.toJSONString(blogService.qryUserCollectBlogList(user.getUid()),SerializerFeature.WriteMapNullValue));
			}catch (Exception e) {
				result.setRespCode(RespCode.FAIL_CODE);
