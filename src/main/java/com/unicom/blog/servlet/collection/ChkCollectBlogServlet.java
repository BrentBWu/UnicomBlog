package com.unicom.blog.servlet.collection;
...
import com.unicom.blog.service.CollectionService;
 ...
 *
 */
@WebServlet("/chkCollectBlog")
public class ChkCollectBlogServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp){
		...
		try{
	        ...
	        resp.getWriter().print(JSON.toJSONString(collectionService.chkCollectBlog(user.getUid(),bid),SerializerFeature.WriteMapNullValue));
			}catch (Exception e) {
				result.setRespCode(RespCode.FAIL_CODE);
